package ssg.rwamp.demo.infrastructure;
...
/**
 * In-memory WAMP transport for demos and testing.
 * <p>
 * Uses a pair of blocking queues to connect two endpoints.
 * Messages sent by one side are received by the other.
 * This is a local copy — lego-flow's InMemoryTransport is in test scope
...
public class InMemoryTransport implements WampTransport {
     ...
     *
     * @return an array of two connected transports: [sideA, sideB]
     */
